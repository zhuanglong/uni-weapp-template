...
test('getFullURL1', () => {
  ...
  expect(getFullURL('http://www.xxx.com', 'user', {})).toBe('http://www.xxx.com/user');
  expect(getFullURL('http://www.xxx.com', '/user', {})).toBe('http://www.xxx.com/user');
  expect(getFullURL('http://www.xxx.com/', 'user', {})).toBe('http://www.xxx.com/user');
  expect(getFullURL('http://www.xxx.com/', '/user', {})).toBe('http://www.xxx.com/user');
  ...
  expect(getFullURL('http://www.xxx.com/', 'http://www.xxx.com/user2/login', {})).toBe(
    'http://www.xxx.com/user2/login',
  );

  expect(getFullURL('api/', 'user/getList', { id: 1 })).toBe('api/user/getList?id=1');
  expect(getFullURL('api/', 'user/getList?id=2', { age: 18 })).toBe('api/user/getList?id=2&age=18');
  expect(getFullURL('api/', 'user/getList?id=2', { id: 2 })).toBe('api/user/getList?id=2&id=2');
